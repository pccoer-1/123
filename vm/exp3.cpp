Your code is a correct implementation of the N-Queens Problem using backtracking, but I’ll fix a few issues, improve safety, and then explain it line-by-line + viva questions.
...
* safer diagonal checks
* proper memory cleanup (important in C++)
* cleaner logic (no major algorithm change)
